...
document.getElementById("to_be_drawn").innerHTML = sketch;
time_counter = 0;
time_check = "";
drawn_sketch = "";
answer_holder ="";
...
{ 
    if(drawn_sketch == sketch)
    {
        ...
        document.getElementById("a").innerHTML = "Oh I know it is "
        document.getElementById("guess").innerHTML = sketch;
    }
    strokeWeight(13);
    stroke(0);
    if(mouseIsPressed){
